...
<table border="1">
<tr><td colspan="2" align="center">Register Form</td></tr>
<tr><td>Account Number</td><td><input type="text" name="acno"></td></tr>
<tr><td>Name </td><td><input type="text" name="name"></td></tr>
<tr><td>Password</td><td><input type="password" name="password"></td></tr>
<tr><td>Confirm Password</td><td><input type="password" name="cnfpassword"></td></tr>
<tr><td>Amount</td><td><input type="text" name="amount"></td></tr>
<tr><td>Address</td><td><input type="text" name="address"></td></tr>
<tr><td>Mobile No</td><td><input type="tel" name="mobno"></td></tr>
